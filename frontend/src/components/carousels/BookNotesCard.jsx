...
const BookNotesCard = ({ item }) => {
  ...
  return (
    <>
      <div
        className={`bg-[#ffff] hover:bg-gray-400 transition-all ease-in duration-300 lg:w-fit lg:h-[40vh] md:h-[40vh] h-[45vh] flex flex-col items-center rounded-2xl shadow-[0px_4px_10px_rgba(0,0,0,0.25)] p-5 backdrop-blur-none w-[85%] ${
