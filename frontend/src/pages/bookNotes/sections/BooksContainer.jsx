      ...
      <section id="booksContainer" className="px-[1vw] py-5">
        ...
        <div
          className={clsx(
            ...
            "lg:flex lg:justify-center lg:gap-10 lg:max-h-[50vw] lg:px-4 lg:py-10  lg:max-w-[70vw]"
          )}
        >
        ...
        <div
          className={clsx(
            "flex justify-between flex-nowrap overflow-hidden shrink-0 min-h-[5vw] px-6 lg:hidden"
          )}
        >
          <Swiper
            effect="coverflow"
