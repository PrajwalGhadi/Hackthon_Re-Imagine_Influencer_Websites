...
const BookNotesPage = () => {
  ...
  const { bookNotesPageData, landingPageData } = useContext(ContextAPI);
  ...
  return (
    <>
      <main
        className={clsx(
          "w-full pt-[15vw]",
          "lg:gap-[2vw] lg:pt-[5vw] md:py-[10vw]"
        )}
        id="BookNotesPage"
      >
        <PensieveCard pensieve={bookNotesPageData?.pensieveCard} newsletter = {newsletter} />
